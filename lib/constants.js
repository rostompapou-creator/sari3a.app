...
export const STATUS_STEPS = [
  { key: "pending", label: "En attente", type: "progress" },
  { key: "picked_up", label: "Recupere chez le partenaire", type: "progress" },
  { key: "sorting", label: "En tri", type: "progress" },
  { key: "in_transit", label: "En transit", type: "progress" },
  { key: "out_for_delivery", label: "En livraison", type: "progress" },
  { key: "delivered", label: "Livre", type: "progress" }
]
